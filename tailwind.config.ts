...
export default {
  ...
  theme: {
    extend: {
      ...
      width: {
        'poster-tile-sm': '152px',
        'poster-tile-md': '200px',
        'poster-tile-lg': '220px',
        'poster-tile-xl': '260px',
      },
      flexBasis: {
        'poster-tile-sm': '152px',
        'poster-tile-md': '200px',
      ...
      height: {
        'poster-tile-sm': '286px',
        'poster-tile-md': '376px',
        'poster-tile-lg': '420px',
        'poster-tile-xl': '480px',
      },
    },
  },
  plugins: [],
